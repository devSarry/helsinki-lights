...
#define MIDI_LENGTH 10
#define CONFIG_OFFSET 22 // sum of previous - where configs start in memory
...
public:
    ...
    void clearMidiValues(bool reboot);
    void startAP();
...
private:
    ...
    void readConfig();
    void writeConfig();
    void storeMidiValues(String pitch, String velocity, bool resetMagic);
